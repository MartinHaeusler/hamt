package org.neatutils.collections.immutable.hamt;

import com.google.common.collect.Iterators;
import org.neatutils.collections.immutable.ImmutableMap;
import org.neatutils.collections.immutable.base.AbstractImmutableCollection;
import org.neatutils.collections.immutable.base.AbstractImmutableSet;
import org.neatutils.collections.immutable.base.ImmutableEntry;
import org.neatutils.collections.util.BitFieldUtil;
import org.neatutils.collections.util.Pair;
...
public class HashArrayMappedTree<K, V> implements ImmutableMap<K, V> {
	...
	private HashArrayMappedTree<K, V> clonePathBackToRootAndCreateTree(final AMTPath<K, V> traversedPath,
        ...
        HAMTNode<K, V> repNode = replacementNode;
		for (int i = traversedPath.length() - 1; i >= 0; i--) {
            ...
            repNode = asIndexNode(node).replaceChild(childNodeBits, repNode);
		}
		// our replacement node is now the root for our new tree
		return new HashArrayMappedTree<>(repNode);
	}
