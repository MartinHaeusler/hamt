...
import org.neatutils.collections.immutable.hamt.HAMTIndexNode;
import org.neatutils.collections.immutable.hamt.HAMTLeafNode;
import org.neatutils.collections.immutable.hamt.HAMTNode;
import org.neatutils.collections.immutable.hamt.HashArrayMappedTree;
...
public class HashArrayMappedTreeTest {
    ...
    private static <T> void deconstructTreeInAllPermutationsUntilEmptyAndTest(final ImmutableMap<T, ?> map) {
        ...
        Iterator<List<T>> permutationIterator = Collections2.permutations(keySet).iterator();
